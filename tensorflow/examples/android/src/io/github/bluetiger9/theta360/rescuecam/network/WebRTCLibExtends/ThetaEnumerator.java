...
public class ThetaEnumerator implements CameraEnumerator {
    private final static String TAG = "ThetaEnumerator";
    ...
    public ThetaEnumerator() {
        this(true /* captureToTexture */);
    }

    public ThetaEnumerator(boolean captureToTexture) {
    ...
    public CameraVideoCapturer createCapturer(
        ...
        return new ThetaCapturer(deviceName, eventsHandler, captureToTexture);
    }
